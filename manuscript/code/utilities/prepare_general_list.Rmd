...
sampleData <- data.table(as.data.frame(read_xlsx('ONT Master Table.xlsx', sheet = 1))) ## need to convert from tibble to data.frame
...
# pacbio data are generated from different replicates 
