...
fusion_gene <- fread(paste0("jaffa_results.filtered.210820.csv"))
...
saveRDS(ensemblAnnotations.genes, file = "ensemblAnnotationGenes_updated.rds")
```
...
fusion_gene = readRDS("fusion_gene_updated.rds")
...
saveRDS(list(fusionGene, fusionTx, break.pointList,gr, prime3Gene, prime5Gene,
             geneList, txList), file = paste0("fusionGeneTxBreakPointGR.rds"))
```
...
old_fig_mat <- fread("fusion_mat_updated_29Aug2023.csv")
...
saveRDS(fusionAnnotations_ucsc, file = "fusionAnnotations_ucsc_13Sep2023.rds")
saveRDS(unlisted_annotations,file = "fusionAnnotations_ucsc_unlisted_13Sep2023.rds" )
...
write.table(bed_file, file = "bed_file_13Sep2023.bed",row.names = FALSE, col.names = FALSE, sep = "\t")
```
...
```{r}
seFusion_NDR0.668 <- readRDS("seFusion_fusionModeOn_recommendedNDR0.668_25Aug2023.rds")
seFusion <- readRDS("seFusion_BambuRevisionBranch_fusionModeOn_NDR1.rds")
